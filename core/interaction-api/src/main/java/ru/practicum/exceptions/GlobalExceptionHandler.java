...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleFeignException(FeignException e) {
        ...
        response.put("reason", "Error from external service.");
        response.put("message", e.getMessage());
        response.put("timestamp", LocalDateTime.now()
                .format(java.time.format.DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss")));
    ...
    public ResponseEntity<Map<String, Object>> handleNoFallbackAvailableException(Exception e) {

        Map<String, Object> response = new HashMap<>();
        response.put("status", "SERVICE_UNAVAILABLE");
        response.put("reason", "External service is temporarily unavailable.");
        response.put("message", e.getMessage());
        response.put("timestamp", LocalDateTime.now()
                .format(java.time.format.DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss")));
    ...
    public ResponseEntity<Map<String, Object>> handleUnhandledException(Exception e) {
        ...
        response.put("reason", "Unexpected error occurred.");
        response.put("message", e.getMessage());
        response.put("timestamp", LocalDateTime.now()
                .format(java.time.format.DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss")));
